            ...
            <div className="absolute left-1/2 -translate-x-1/2">
              ...
              >
                ...
                <button
                  ...
                  className={`group/btn relative z-10 w-7 h-5 flex items-center justify-center transition-colors duration-200 ${lastNavView === "main" ? "text-blue-400" : "text-t4 hover:text-t2"}`}
                >
                ...
                <button
                  ...
                  className={`group/btn relative z-10 w-7 h-5 flex items-center justify-center transition-colors duration-200 ${lastNavView === "reminders" ? "text-indigo-400" : "text-t4 hover:text-t2"}`}
                >
                ...
                <button
                  ...
                  className={`group/btn relative z-10 w-7 h-5 flex items-center justify-center transition-colors duration-200 ${lastNavView === "notes" ? "text-emerald-400" : "text-t4 hover:text-t2"}`}
                >
