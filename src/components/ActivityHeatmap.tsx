...
export default function ActivityHeatmap() {
  ...
  return (
    <div className="rounded-xl p-3 flex flex-col gap-2 select-none h-full justify-between" style={{ background: `rgba(${ACCENT},0.06)`, border: `1px solid rgba(${ACCENT},0.2)`, minWidth: "max-content" }}>
